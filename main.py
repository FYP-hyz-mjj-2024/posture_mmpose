...
def main(default_config):
    ...
    # Posture classifier
    model_state = torch.load('step02_train_model_cnn/archived_models/posture_mmpose_vgg3d_20250320-112914.pth',
    ...
    # Start the loop
    demo_performance = videoDemo(src=int(user_config["video_source"]) if user_config["video_source"] is not None else 0,
                                 # Model Task packages
...
if __name__ == '__main__':
    ...
    from utils.opencv_utils import getUserConsoleConfig
